...
type DeleteContratistaButtonProps = {
    action: (formData: FormData) => void | Promise<void>;
    contratistaId: number;
    razonSocial: string;
};

export function DeleteContratistaButton({ action, contratistaId, razonSocial }: DeleteContratistaButtonProps) {
    ...
    return (
        <>
            <form action={action} ref={formRef}>
                <input name="id" type="hidden" value={contratistaId} />
                <button
                ...
                >
                    ...
                    >
                        ...
                        <p className="mt-3 text-base leading-7 text-slate-600">
                            Esta acción no se puede deshacer y puede bloquearse si el contratista ya tiene relaciones activas.
                        </p>
                        <div className="mt-5 rounded-[24px] border border-slate-200/80 bg-slate-50/80 px-4 py-4">
                            ...
                            <p className="mt-2 text-lg font-semibold text-slate-950">{razonSocial}</p>
                        </div>
