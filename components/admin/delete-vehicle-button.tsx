...
export function DeleteVehicleButton({ action, vehicleId, licensePlate }: DeleteVehicleButtonProps) {
    ...
    return (
        <>
            <form action={action} ref={formRef}>
                <input name="id" type="hidden" value={vehicleId} />
                <button
                ...
                >
                    ...
                    >
                        ...
                        <div className="mt-5 rounded-[24px] border border-slate-200/80 bg-slate-50/80 px-4 py-4">
                            ...
                            <p className="mt-2 text-lg font-semibold tracking-[0.18em] text-slate-950">{licensePlate}</p>
                        </div>
